---
title: "BM932 Microbiology Paper Presentations (Assessment 2)"
author: "Morgan Feeney"
date: "2023 Presentation"
output: 
...
<div id="summary">
- A summary of some of the issues that you should consider when planning your paper presentation (for Assessment 2): content, methods, data presentation, aesthetics, delivering your presentation.
- Some of the common mistakes we see in paper presentations (a.k.a journal club presentations), and how to avoid them
- Suggested additional reading on how to give good presentations
</div>

# Introduction

This is a companion guide to the BM932 workshop series, where we discuss how to analyse a scientific paper. We have collated some information and helpful tips that will assist you in preparing your paper presentation (which you will present for Assessment 2). However, reading these tips is not a substitute for attending the workshops, where we will go into much more detail on how to analyse and discuss a scientific paper. 

# The Anatomy of a Journal Club Presentation

Every talk is different, and all of the papers we look at in BM932 are different - but every paper presentation/journal club talk should contain the following elements in some form: 

- An explanation of the problem that the authors were trying to solve, and the context they were working in (what was known before the authors began this study, and what they were trying to achieve)
...
- An explanation of the significance of the work (what other work will be made possible because of this paper? how does it change our understanding of microbiology?)
...
Remember, for each experiment, explain: 1. what the authors were trying to achieve (their aim), 2. what the authors did (the experiment/method), 3. what the authors found (the results), 4. what it all means (the significance).
...
*Background/significance lacking*
...
- Please e-mail Dr. Feeney or Dr. Herron with any questions or with any suggestions for how we can improve these pages.
