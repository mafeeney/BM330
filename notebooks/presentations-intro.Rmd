...
- Common types of questions asked after these presentations might include (but are not limited to):
  ...
  - Questions about the methods used in the paper
  - Extrapolating questions (how might the findings of this paper apply to other systems/organisms/scenarios?) 
  - Questions testing your understanding of the underlying biology or microbiology discussed in your paper/presentation
- A key skill in answering questions is making sure that you have actually answered the question that was asked. Sometimes presenters hear one or two key words/phrases and start constructing an answer based on those, instead of actually answering the question. Listen carefully to the question, and if you are not sure you understand it - ask the questioner to repeat it.
